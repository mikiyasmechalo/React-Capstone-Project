...
const ContactInfoGrid = () => {
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-15 text-lg">
        {contactItems.map((item, index) => (
          <div
            key={index}
            className={`${index >= 2 ? "hidden md:block" : ""} space-y-6`}
          >
            <h3 className="text-2xl font-normal mb-5">{item.city}</h3>
