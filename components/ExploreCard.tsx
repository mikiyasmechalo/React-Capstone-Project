...
// const ExploreCard = ({ nowViewing, title, imageSrc, description }: Props) => {
//   return (
//     <div className="flex">
//       <div className="relative flex flex-col">
//         {nowViewing && (
//           <Image
//             src={imageSrc || "/explore-img.png"} // Use provided imageSrc or default
//             alt="explore-img"
//             height={nowViewing ? 316 : 361} // Conditional height
//             width={nowViewing ? 442 : 444} // Conditional width
//           />
//         )}
...
//             </div>
//             <div className="p-3">
//               <h2 className="text-2xl max-w-110 font-semibold mb-2 mt-3">
//                 {title}
//               </h2>
//               <p className="max-w-100 text-sm text-[#555555]">{description}</p>
//             </div>
//           </div>
//         )}
//       </div>
...
const ExploreCard = ({ nowViewing, title, imageSrc, description }: Props) => {
  return (
    <div
      className={`flex flex-col m-4 justify-start items-center 
         ${
           nowViewing
             ? " bg-white shadow-lg rounded-lg"
             : ""
         } max-w-sm transition-all duration-300 overflow-hidden`}
    >
      {/* Image Container */}
      <div
        className={`overflow-hidden relative transition-all duration-300 ${
          nowViewing ? "w-full h-62 rounded-t-lg " : "w-90 h-70 rounded-lg"
        }`}
      >
        <Image
      ...
      {/* Content (Shown when nowViewing is true) */}
      {nowViewing && (
        <div className="p-3 relative">
          ...
          <h2 className="text-2xl max-w-110 font-semibold mb-2 mt-5">
            {title}
          </h2>
          <p className="max-w-100 mb-5 text-sm text-[#555555]">{description}</p>
        </div>
      )}
    </div>
  );
