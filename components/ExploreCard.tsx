...
const ExploreCard = ({
  ...
  imageSrc,
  description,
}: ExploreCardProps & { nowViewing: boolean }) => {
  return (
    <div
      ...
      >
        {nowViewing && (
          <div className="relative flex-col flex">
            <div className="absolute right-[-15px] top-[-55px] hidden md:block">
              <QuoteIcon />
            </div>
            <div className="p-3">
...
const QuoteIcon = () => {
  return (
    <div className="relative inline-block w-[140px] h-[140px]">
      {/* Ellipse (Circle) */}
      <svg
        width="141"
        height="139"
      ...
      >
        <g filter="url(#filter0_d)">
          <ellipse cx="70.5" cy="65.1268" rx="39.5" ry="38.072" fill="white" />
        </g>
        <defs>
          <filter
            id="filter0_d"
      ...
      {/* Arrow centered over the ellipse */}
      <div className="absolute left-1/2 top-16 transform -translate-x-1/2 -translate-y-1/2">
        <svg
          width="25"
          height="18"
          viewBox="0 0 25 18"
